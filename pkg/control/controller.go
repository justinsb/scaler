...
type Controller struct {
	...
	scalingPoliciesLister scalingpolicylister.ScalingPolicyLister
...
func NewController(
	...
	scalingPolicyInformer := scalerInformerFactory.Scalingpolicy().V1alpha1().ScalingPolicies()
...
func (c *Controller) syncHandler(key string) error {
	...
	scalingPolicy, err := c.scalingPoliciesLister.ScalingPolicies(namespace).Get(name)
	if err != nil {
