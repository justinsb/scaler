...
type ExampleInterface interface {
	Create(*v1alpha1.Example) (*v1alpha1.Example, error)
	Update(*v1alpha1.Example) (*v1alpha1.Example, error)
	Delete(name string, options *v1.DeleteOptions) error
	DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error
	Get(name string, options v1.GetOptions) (*v1alpha1.Example, error)
	List(opts v1.ListOptions) (*v1alpha1.ExampleList, error)
	Watch(opts v1.ListOptions) (watch.Interface, error)
	Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha1.Example, err error)
	ExampleExpansion
}
...
func newExamples(c *ScalingpolicyV1alpha1Client, namespace string) *examples {
	return &examples{
		client: c.RESTClient(),
		ns:     namespace,
	}
...
func (c *examples) Get(name string, options v1.GetOptions) (result *v1alpha1.Example, err error) {
...
func (c *examples) List(opts v1.ListOptions) (result *v1alpha1.ExampleList, err error) {
...
func (c *examples) Watch(opts v1.ListOptions) (watch.Interface, error) {
	opts.Watch = true
	return c.client.Get().
		Namespace(c.ns).
		Resource("examples").
...
func (c *examples) Create(example *v1alpha1.Example) (result *v1alpha1.Example, err error) {
	result = &v1alpha1.Example{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("examples").
...
func (c *examples) Update(example *v1alpha1.Example) (result *v1alpha1.Example, err error) {
	result = &v1alpha1.Example{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("examples").
...
func (c *examples) Delete(name string, options *v1.DeleteOptions) error {
...
func (c *examples) DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error {
	return c.client.Delete().
		Namespace(c.ns).
		Resource("examples").
...
func (c *examples) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha1.Example, err error) {
	result = &v1alpha1.Example{}
