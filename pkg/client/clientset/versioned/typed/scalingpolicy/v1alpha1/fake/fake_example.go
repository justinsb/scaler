...
var examplesResource = schema.GroupVersionResource{Group: "scalingpolicy.kope.io", Version: "v1alpha1", Resource: "examples"}

var examplesKind = schema.GroupVersionKind{Group: "scalingpolicy.kope.io", Version: "v1alpha1", Kind: "Example"}

// Get takes name of the example, and returns the corresponding example object, and an error if there is any.
func (c *FakeExamples) Get(name string, options v1.GetOptions) (result *v1alpha1.Example, err error) {
	obj, err := c.Fake.
...
func (c *FakeExamples) List(opts v1.ListOptions) (result *v1alpha1.ExampleList, err error) {
	obj, err := c.Fake.
...
func (c *FakeExamples) Create(example *v1alpha1.Example) (result *v1alpha1.Example, err error) {
	obj, err := c.Fake.
...
func (c *FakeExamples) Update(example *v1alpha1.Example) (result *v1alpha1.Example, err error) {
	obj, err := c.Fake.
...
func (c *FakeExamples) Delete(name string, options *v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewDeleteAction(examplesResource, c.ns, name), &v1alpha1.Example{})
...
func (c *FakeExamples) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha1.Example, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewPatchSubresourceAction(examplesResource, c.ns, name, data, subresources...), &v1alpha1.Example{})
